...
const App = () => {
  ...
  return (
    <div className="App" style={{ height: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', alignItems: 'center', padding: '12px', boxSizing: 'border-box' }}>
      <img src="/logo.png" alt="Visualize 3 Logo" style={{ height: boardSize > 360 ? '200px' : '120px', marginBottom: '4px' }} />
      <h1 style={{ fontSize: '22px', marginTop: 0, marginBottom: '8px' }}>Chess Visualization Trainer</h1>
