...
function App() {
  ...
  const playMoveSequence = (moves, isCorrect) => {
    ...
    setTimeout(() => {
      setFeedbackMessage(isCorrect
        ? `Correct! Well done!${puzzles[currentPuzzleIndex].explanation ? ' ' + puzzles[currentPuzzleIndex].explanation : ''}`
  ...
  return (
    <div className="App" style={{ padding: 20, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      <img src="/logo.png" alt="Visualize 3 Logo" style={{ height: '100px', marginBottom: '10px' }} />
